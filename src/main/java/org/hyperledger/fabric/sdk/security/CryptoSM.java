...
public class CryptoSM implements CryptoSuite {
    ...
    public byte[] sign(PrivateKey key, byte[] plainText) throws CryptoException {
        ...
        try {
            ...
            byte[] sign = instance.sign(key, plainText);
...
//        return hash;
    ...
    public static void main(String[] args) throws IllegalAccessException, InstantiationException, ClassNotFoundException {
        String a = "-----BEGIN CERTIFICATE REQUEST-----\r\\r\n-----END CERTIFICATE REQUEST-----\r\n";
        byte[] bytes = new CryptoSM().certificateToDER(a);

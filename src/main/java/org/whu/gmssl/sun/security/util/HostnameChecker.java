...
package org.whu.gmssl.sun.security.util;

import org.whu.gmssl.sun.security.ssl.Krb5Helper;
...
public class HostnameChecker {
    ...
    private void matchDNS(String expectedName, X509Certificate cert)
        ...
        sun.security.util.DerValue derValue = subjectName.findMostSpecificAttribute

    ...
    void protocolDetermined(ProtocolVersion pv) {
        ...
        if (pv.isIsgm()) {
            if (pv.minor == 0) {
                ...
                if (pv.minor != 2) {
                    throw new RuntimeException("unsupported protocol version " + pv.major + "." + pv.minor);
                }
        ...
        switch (version) {
            ...
            case 3:
                try {
                    ...
                    throw new RuntimeException("Algorithm SHA or SM3 not available", e);
                }

...
import org.whu.gmssl.sun.security.provider.certpath.AlgorithmChecker;
...
public abstract class SSLContextImpl extends SSLContextSpi {
    ...
    protected void engineInit(KeyManager[] km, TrustManager[] tm,
        ...
        if (sr == null) {
            ...
            if (GMJsse.isFIPS() &&
                        (sr.getProvider() != GMJsse.cryptoProvider)) {
                throw new KeyManagementException
                    ("FIPS mode: SecureRandom must be from provider "
                    + GMJsse.cryptoProvider.getName());
            }
            secureRandom = sr;
        }
        ...
        for (int i = 0; tm != null && i < tm.length; i++) {
            if (tm[i] instanceof X509TrustManager) {
                ...
                if (GMJsse.isFIPS() &&
                    ...
                    throw new KeyManagementException
                        ("FIPS mode: only GMJsse TrustManagers may be used");
                }
        ...
        for (int i = 0; kms != null && i < kms.length; i++) {
            ...
            if (GMJsse.isFIPS()) {
                ...
                if ((km instanceof X509KeyManagerImpl)
                    ...
                    throw new KeyManagementException
                        ("FIPS mode: only GMJsse KeyManagers may be used");
                }
            }
    ...
    public static final class GMTLS10Context extends SSLContextImpl {
        private final static SSLParameters defaultServerSSLParams;
    ...
    public static final class GMTLS11Context extends SSLContextImpl {
        private final static SSLParameters defaultServerSSLParams;
        private final static SSLParameters defaultClientSSLParams;
        private final static SSLParameters supportedSSLParams;
    ...
    private static class CustomizedSSLContext extends AbstractSSLContext {
        ...
        static {
            ...
            if (property == null || property.length() == 0) {
                ...
                //TODO modify by ringo
                if ((reservedException == null) && GMJsse.isFIPS()) {

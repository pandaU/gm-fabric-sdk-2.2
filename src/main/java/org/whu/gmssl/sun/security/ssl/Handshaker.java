...
import org.whu.gmssl.sun.security.ssl.CipherSuite.BulkCipher;
import org.whu.gmssl.sun.security.ssl.CipherSuite.KeyExchange;
import org.whu.gmssl.sun.security.ssl.CipherSuite.MacAlg;
...
import static org.whu.gmssl.sun.security.ssl.CipherSuite.CipherType.AEAD_CIPHER;
import static org.whu.gmssl.sun.security.ssl.CipherSuite.CipherType.BLOCK_CIPHER;
...
abstract class Handshaker {
    ...
    void calculateConnectionKeys(SecretKey masterKey) {
        ...
        if (protocolVersion.v >= ProtocolVersion.TLS12.v) {
            ...
            if (this.protocolVersion.isIsgm()) {
                keyMaterialAlg = "GBTlsKeyMaterial";
            } else {
